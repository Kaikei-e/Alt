...
const (
	...
	SearchServiceName = "alt.search.v2.SearchService"
)
...
const (
	...
	// SearchArticles RPC.
	SearchServiceSearchArticlesProcedure = "/alt.search.v2.SearchService/SearchArticles"
)

// SearchServiceClient is a client for the alt.search.v2.SearchService service.
...
// NewSearchServiceClient constructs a client for the alt.search.v2.SearchService service. By
...
func NewSearchServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SearchServiceClient {
	...
	searchServiceMethods := v2.File_alt_search_v2_search_proto.Services().ByName("SearchService").Methods()
...
// SearchArticles calls alt.search.v2.SearchService.SearchArticles.
...
// SearchServiceHandler is an implementation of the alt.search.v2.SearchService service.
...
func NewSearchServiceHandler(svc SearchServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/alt.search.v2.SearchService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSearchServiceHandler) SearchArticles(context.Context, *connect.Request[v2.SearchArticlesRequest]) (*connect.Response[v2.SearchArticlesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("alt.search.v2.SearchService.SearchArticles is not implemented"))
}
