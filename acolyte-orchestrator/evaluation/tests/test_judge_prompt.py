...
class TestBuildJudgePrompt:
    def test_includes_rubric_and_shots(self) -> None:
    ...
    def test_sanitises_evidence_tag_injection_in_payload(self) -> None:
    ...
    def test_empty_evidence_does_not_crash(self) -> None:
...
class TestParseJudgeOutput:
    ...
    def test_valid_rubric_values(self, raw: str, expected: float) -> None:
        assert parse_judge_output(raw) == expected

    def test_snaps_near_rubric_values(self) -> None:
