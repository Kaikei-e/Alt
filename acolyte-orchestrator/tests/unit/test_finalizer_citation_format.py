...
class TestRenderSourcesFooter:
    def test_preserves_short_ids_inline(self) -> None:
        sm = SourceMap()
    ...
    def test_appends_sources_footer_in_reference_order(self) -> None:
        sm = SourceMap()
    ...
    def test_only_emits_referenced_sources(self) -> None:
        sm = SourceMap()
    ...
    def test_footer_entry_includes_title_publisher_url(self) -> None:
        sm = SourceMap()
        sm.register(
            "abc-123",
            "AI Chip Report 2026",
    ...
    def test_footer_handles_missing_publisher_url(self) -> None:
        sm = SourceMap()
    ...
    def test_no_short_ids_returns_body_unchanged(self) -> None:
        sm = SourceMap()
        body = "No citations here. Just text."
        assert render_sources_footer(body, sm) == body

    def test_multiple_same_id_emitted_once_in_footer(self) -> None:
        sm = SourceMap()
    ...
    def test_unknown_short_id_skipped_in_footer(self) -> None:
        sm = SourceMap()
