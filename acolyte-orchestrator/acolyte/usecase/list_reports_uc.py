...
class ListReportsUsecase:
    ...
    async def execute(self, cursor: str | None, limit: int, user_id: UUID) -> tuple[list[Report], str | None]:
        return await self._report_repo.list_reports(cursor, limit, user_id=user_id)
