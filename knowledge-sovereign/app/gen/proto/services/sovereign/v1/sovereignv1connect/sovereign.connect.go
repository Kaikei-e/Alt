...
func NewKnowledgeSovereignServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) KnowledgeSovereignServiceClient {
	...
	return &knowledgeSovereignServiceClient{
		...
		getTrailFootprints: connect.NewClient[v1.GetTrailFootprintsRequest, v1.GetTrailFootprintsResponse](
			httpClient,
			baseURL+KnowledgeSovereignServiceGetTrailFootprintsProcedure,
...
// GetTrailFootprints calls services.sovereign.v1.KnowledgeSovereignService.GetTrailFootprints.
func (c *knowledgeSovereignServiceClient) GetTrailFootprints(ctx context.Context, req *connect.Request[v1.GetTrailFootprintsRequest]) (*connect.Response[v1.GetTrailFootprintsResponse], error) {
...
func NewKnowledgeSovereignServiceHandler(svc KnowledgeSovereignServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	knowledgeSovereignServiceGetTrailFootprintsHandler := connect.NewUnaryHandler(
		KnowledgeSovereignServiceGetTrailFootprintsProcedure,
		svc.GetTrailFootprints,
		connect.WithSchema(knowledgeSovereignServiceMethods.ByName("GetTrailFootprints")),
		connect.WithHandlerOptions(opts...),
	)
