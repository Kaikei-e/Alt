...
import { type BackendIdentityHeaders, buildBackendIdentityHeaders } from "./backend-headers";
...
export const getServerSessionHeaders = async (): Promise<BackendIdentityHeaders | null> => {
