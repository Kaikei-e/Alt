...
/**
 * Generates an excerpt from HTML content by extracting plain text
...
export function generateExcerpt(
  ...
  // Remove HTML tags using a simple regex (for server-side use)
  // This is safe because content is already sanitized by backend
