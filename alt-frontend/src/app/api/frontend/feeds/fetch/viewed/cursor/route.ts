/**
 * API Route: /api/frontend/feeds/fetch/viewed/cursor
...
export async function GET(request: NextRequest) {
  try {
    ...
    const backendEndpoint = `${backendUrl}/v1/feeds/fetch/viewed/cursor${queryString ? `?${queryString}` : ""}`;
    ...
    console.error("Error in /api/frontend/feeds/fetch/viewed/cursor:", error);
