...
export const mockDesktopFeeds: DesktopFeed[] = [
  {
    ...
    metadata: {
      ...
      summary:
        "This breakthrough in AI technology promises to transform how businesses approach automation and decision-making processes...",
      priority: "high",
      category: "tech",
  ...
  },
  {
    ...
    description:
      "Exploring the latest features and improvements in React 19, including concurrent rendering and server components.",
    ...
    metadata: {
      ...
      author: "Alex Chen",
      summary:
        "React 19 introduces game-changing features that will revolutionize how we build modern web applications...",
      priority: "medium",
      category: "development",
      difficulty: "advanced",
    },
  ...
  },
  {
    ...
    description:
      "How to create environmentally conscious designs that reduce digital carbon footprints while maintaining excellent user experiences.",
    ...
    metadata: {
      ...
      summary:
        "Sustainable design is becoming increasingly important as digital products consume more energy...",
      priority: "low",
      category: "design",
      difficulty: "beginner",
    },
  ...
  },
  {
    ...
    description:
      "A comprehensive guide to architecting distributed systems using Go microservices deployed on Kubernetes.",
    ...
    metadata: {
      ...
      author: "John Doe",
      summary:
        "Learn how to build production-ready microservices using Go's concurrent features and Kubernetes orchestration...",
      priority: "high",
      category: "backend",
      difficulty: "advanced",
    },
  ...
  },
  {
    ...
    description:
      "Master advanced CSS Grid techniques to create complex, responsive layouts with minimal code.",
    ...
    metadata: {
      ...
      author: "Chris Coyier",
      summary:
        "Explore powerful CSS Grid techniques that go beyond basic layouts to create stunning responsive designs...",
      priority: "medium",
      category: "frontend",
      difficulty: "intermediate",
    },
