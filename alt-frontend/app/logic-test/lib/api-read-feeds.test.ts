...
describe('ReadFeeds API Client - TDD Implementation', () => {
  ...
  describe('getReadFeedsWithCursor', () => {
    ...
    it('should fetch read feeds with default parameters', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/v1/feeds/fetch/read/cursor?limit=20', 10);
    ...
    it('should fetch read feeds with cursor and custom limit', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/v1/feeds/fetch/read/cursor?limit=50&cursor=cursor123', 15);
  ...
  describe('prefetchReadFeeds', () => {
    it('should prefetch read feeds with given cursors', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/v1/feeds/fetch/read/cursor?limit=20&cursor=cursor1', 15);
      expect(mockGet).toHaveBeenCalledWith('/v1/feeds/fetch/read/cursor?limit=20&cursor=cursor2', 15);
      expect(mockGet).toHaveBeenCalledWith('/v1/feeds/fetch/read/cursor?limit=20&cursor=cursor3', 15);
    });
