...
describe('Stats Page Error Handling', () => {
  ...
  describe('Safe Number Formatting', () => {
    ...
    it('should handle edge cases', () => {
      expect(safeFormatNumber(Number.MAX_SAFE_INTEGER)).toBe('9,007,199,254,740,991');
  ...
  describe('SSE Data Processing', () => {
    ...
    it('should handle null/undefined values', () => {
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith('Invalid feed_amount:', null);
    ...
    it('should handle invalid data types', () => {
      ...
      expect(mockSetTotalArticlesAmount).toHaveBeenCalledWith(0);
      expect(mockConsole.warn).toHaveBeenCalledWith('Invalid feed_amount:', 'not a number');
      expect(mockConsole.warn).toHaveBeenCalledWith('Invalid unsummarized_feed amount:', []);
      expect(mockConsole.warn).toHaveBeenCalledWith('Invalid total_articles amount:', {});
    });
    ...
    it('should handle negative numbers', () => {
      ...
      expect(mockSetUnsummarizedArticlesAmount).toHaveBeenCalledWith(0);
      expect(mockSetTotalArticlesAmount).toHaveBeenCalledWith(0);
      expect(mockConsole.warn).toHaveBeenCalledWith('Invalid feed_amount:', -100);
      expect(mockConsole.warn).toHaveBeenCalledWith('Invalid unsummarized_feed amount:', -50);
      expect(mockConsole.warn).toHaveBeenCalledWith('Invalid total_articles amount:', -200);
    });
    ...
    it('should handle extremely large numbers', () => {
      ...
      expect(mockSetFeedAmount).toHaveBeenCalledWith(Number.MAX_SAFE_INTEGER + 1); // Still finite
      expect(mockSetUnsummarizedArticlesAmount).toHaveBeenCalledWith(0);
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith('Invalid unsummarized_feed amount:', Infinity);
    });
    ...
    it('should handle partial failures gracefully', () => {
      ...
      expect(mockSetUnsummarizedArticlesAmount).toHaveBeenCalledWith(7);
      expect(mockSetTotalArticlesAmount).toHaveBeenCalledWith(1337);
      expect(mockConsole.error).toHaveBeenCalledWith('Error updating feed amount:', expect.any(Error));
    });
  });
  ...
  describe('Error Boundary Testing', () => {
    it('should handle JSON parsing errors gracefully', () => {
      ...
      try {
        ...
        console.error('Error parsing SSE data:', error, 'Raw data:', invalidJSONData);
        parsedData = null;
      }
    ...
    it('should validate data structure before processing', () => {
      ...
      testCases.forEach(testData => {
        const isValidData = testData && typeof testData === 'object' && !Array.isArray(testData);
