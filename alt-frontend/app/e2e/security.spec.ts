...
test.describe('Security Headers', () => {
  ...
  test('should prevent inline script execution in production-like environment', async ({ page }) => {
  ...
  test('should reject GET requests to CSP report endpoint', async ({ page }) => {
