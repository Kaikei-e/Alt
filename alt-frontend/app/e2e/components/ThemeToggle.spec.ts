...
test.describe('ThemeToggle Component', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await page.waitForSelector('[data-testid="theme-toggle-button"]', { timeout: 30000 });
  });

  test('should render with correct accessibility attributes', async ({ page }) => {
  ...
  test('should be focusable and clickable after theme toggle', async ({ page }) => {
    const toggleButton = page.locator('[data-testid="theme-toggle-button"]');
