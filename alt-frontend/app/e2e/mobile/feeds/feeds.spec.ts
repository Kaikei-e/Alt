...
test.describe('Mobile Feeds Page', () => {
  ...
  test('should load and display initial feeds', async ({ page }) => {
    ...
    await expect(page.locator('text=Description for test feed 1').first()).toBeVisible();
  });
  ...
  test('should render feed cards with correct structure', async ({ page }) => {
    ...
    await expect(page.locator('a[href="https://example.com/feed1"]')).toBeVisible();
    await expect(page.locator('a[href="https://example.com/feed1"]')).toHaveAttribute('target', '_blank');
    ...
    await expect(page.locator('text=2024-01-01T12:00:00Z').first()).toBeVisible();
  });
  ...
  test('should handle mark as read functionality', async ({ page }) => {
    ...
    const initialFeedCount = await page.locator('button:has-text("Mark as read")').count();
    ...
    const newFeedCount = await page.locator('button:has-text("Mark as read")').count();
  ...
  test('should implement infinite scrolling', async ({ page }) => {
    ...
    await expect(page.locator('button:has-text("Mark as read")')).toHaveCount(25);
  });
  ...
  test('should handle feed card links correctly', async ({ page }) => {
    ...
    await expect(titleLink).toHaveAttribute('href', 'https://example.com/feed1');
  ...
  test('should show correct published dates', async ({ page }) => {
    ...
    await expect(page.locator('text=2024-01-01T12:00:00Z').first()).toBeVisible();
    await expect(page.locator('text=2024-01-02T12:00:00Z').first()).toBeVisible();
    await expect(page.locator('text=2024-01-03T12:00:00Z').first()).toBeVisible();
  });
  ...
  test('should maintain scroll position during infinite scroll', async ({ page }) => {
    ...
    await expect(page.locator('button:has-text("Mark as read")').nth(5)).toBeVisible();
  });
}); 