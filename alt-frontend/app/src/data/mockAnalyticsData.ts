...
import { ReadingAnalytics, TrendingTopic, SourceAnalytic } from '@/types/analytics';
...
export const mockAnalytics: ReadingAnalytics = {
  today: {
    ...
    topCategories: [
      ...
      { category: 'Business', count: 1, percentage: 8, color: 'var(--accent-tertiary)' }
    ]
  },
  week: {
    totalArticles: 67,
...
export const mockTrendingTopics: TrendingTopic[] = [
  ...
  { tag: 'Design', count: 28, trend: 'stable', trendValue: 0, category: 'design', color: 'var(--accent-tertiary)' },
  { tag: 'Startup', count: 19, trend: 'down', trendValue: -8, category: 'business', color: 'var(--alt-warning)' },
  { tag: 'Web3', count: 15, trend: 'up', trendValue: 34, category: 'tech', color: 'var(--alt-success)' }
];
