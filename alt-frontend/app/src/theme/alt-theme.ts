  ...
  theme: {
    tokens: {
      ...
      gradients: {
        vaporwave: {
          value:
            "linear-gradient(45deg, {colors.alt.pink}, {colors.alt.purple}, {colors.alt.blue})",
        },
        button: {
          value:
            "linear-gradient(45deg, {colors.alt.pink}, {colors.alt.purple})",
        },
        background: {
          value:
            "linear-gradient(135deg, {colors.bg.primary} 0%, {colors.bg.secondary} 50%, {colors.bg.tertiary} 100%)",
        },
        glow: {
        ...
        aurora: {
          value:
            "linear-gradient(135deg, {colors.alt.pink}, {colors.alt.purple}, {colors.alt.blue}, #00d4ff)",
        },
      },
    },
