...
func init() {
	metricsReg.MustRegister(statusGauge, latencyGauge)
}
...
// Gatherer exposes health_deep_* for the ops :9110 scrape. A dedicated
// registry keeps these off prometheus.DefaultRegisterer (PKI F-001).
