...
@app.post("/services.datahub.v1.DataHubService/ListRecapArticles")
...
@app.post("/services.datahub.v1.DataHubService/BatchGetTagsByArticleIDs")
async def batch_get_tags_by_article_ids(req: Request) -> dict[str, Any]:
    ...
    feed_tags, so the recap-worker contract now lives on DataHubService
    (services.datahub.v1, ADR-000954 Wave 2; renamed from alt.datahub.v1 by
    ADR-000955).
    """
