...
// metric family. Prometheus scrapes parent :9110 /metrics, so the composition
// root registers this observer on a private registry served by ListenOps
// rather than DefaultRegisterer.
