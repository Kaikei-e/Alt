---
title: auth-token-manager Clean Architecture リファクタリング
date: 2026-02-07
status: accepted
tags: [api, authentication, clean-architecture, performance, security]
affected_services: [auth-token-manager]
aliases: [ADR-196, ADR-000196]
---
