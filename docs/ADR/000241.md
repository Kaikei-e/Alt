---
title: Shared Database アンチパターンの解消 — alt-backend を唯一のデータオーナーに
date: 2026-02-14
status: accepted
tags: [authentication, clean-architecture, connect-rpc, queue, search]
affected_services: [alt-backend, pre-processor, search-indexer, tag-generator]
aliases: [ADR-241, ADR-000241]
---
...
- [[000266]] tag-generator API モード移行に伴うトランザクション管理コードの修正
