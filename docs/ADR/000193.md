---
title: rask-log-aggregator Clean Architecture リファクタリング + バッチバッファリング
date: 2026-02-07
status: accepted
tags: [clean-architecture, docker, logging, refactoring, testing]
affected_services: [rask-log-aggregator, rask-log-forwarder, recap-worker]
aliases: [ADR-193, ADR-000193]
---
...
- [[000192]] recap-worker Rust 2024 モダナイゼーション (同一プロジェクト内の Rust サービスにおける段階的改善)
- [[000194]] alt-frontend-sv インクリメンタルリファクタリング
