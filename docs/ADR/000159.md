---
title: pre-processorのGetFeedIDにおけるErrNoRows処理の改善
date: 2026-01-29
status: accepted
tags: [docker, frontend, monitoring, rss, testing]
affected_services: [pre-processor]
aliases: [ADR-159, ADR-000159]
---
...
- [[000158]] pre-processorの記事upsert時UUID空文字列エラーの修正
