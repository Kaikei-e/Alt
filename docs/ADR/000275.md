---
title: rag-orchestrator の goroutine リーク・CPU 浪費を Exponential Backoff で修正
date: 2026-02-27
status: accepted
tags: [frontend, rag, testing]
affected_services: [pre-processor, rag-orchestrator]
aliases: [ADR-275, ADR-000275]
---
...
| ADR | 内容 |
|-----|------|
| [[000275|ADR-000275]] (本 ADR) | rag-orchestrator の goroutine リーク・CPU 浪費修正 |
- [[000276]] tag-generator の CPU 浪費を 3 層で修正 (1683% → < 1%)
