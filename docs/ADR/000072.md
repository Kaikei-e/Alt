---
title: 統一ロギング基盤の導入 (OpenTelemetry準拠)
date: 2026-01-10
status: accepted
tags: [database, docker, logging, monitoring, testing]
affected_services: [news-creator, rask-log-aggregator, rask-log-forwarder, tag-generator]
---
