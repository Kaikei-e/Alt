---
title: "Connect-RPC Phase 4-6: Articles / RSS Feed Links / Streaming Summarize の移行"
date: 2025-12-31
status: accepted
tags: [api, authentication, connect-rpc, database, rss]
...
[[000030|ADR-000030]]で完了したConnect-RPC Phase 2-3（Feed List / Search）に続き、Phase 4-6として残りのエンドポイントを移行した。
