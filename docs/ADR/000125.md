---
title: ログパイプラインのTrace Context伝搬完全対応
date: 2026-01-18
status: accepted
tags: [database, logging, monitoring, queue, rag]
affected_services: [alt-backend, mq-hub, rag-orchestrator, rask-log-aggregator, rask-log-forwarder]
aliases: [ADR-125, ADR-000125]
---
...
GrafanaダッシュボードでTraceId/SpanIdが全てゼロ表示される問題が報告された。[[000122|ADR-122]]/[[000123|123]]でOTLP経路の問題は修正されたが、Docker stdout→rask-log-forwarder→rask-log-aggregator経路では依然としてtrace contextが失われていた。
...
- [[000124]] ログパイプラインのTrace Context伝搬完全対応（本ADRの前身、内容統合）
- [[000127]] ADR-124/125実装完了: Trace Context伝搬問題の修正
