---
title: alt-backend 基盤品質・ジョブシステム・パフォーマンス改善
date: 2026-02-06
status: accepted
tags: [database, performance, queue, security, testing]
affected_services: [alt-backend, news-creator, pre-processor]
aliases: [ADR-187, ADR-000187]
---
...
- [[000189]] altctl: Docker Compose 実行時の .env 読み込み不具合修正
