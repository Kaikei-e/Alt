---
title: rask-log-forwarderをOTLP (OpenTelemetry Protocol) 準拠に拡張
date: 2026-01-29
status: accepted
tags: [api, docker, logging, performance]
affected_services: [nginx, rask-log-aggregator, rask-log-forwarder]
aliases: [ADR-157, ADR-000157]
---
...
- [[000091]] rask-log-aggregatorのOTLP受信機能（aggregator側の実装）
