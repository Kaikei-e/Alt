---
title: "Connect-RPC Phase 2-3: Feed List / Search エンドポイントの移行"
date: 2025-12-31
status: accepted
tags: [api, connect-rpc, database, rss, testing]
...
[[000028|ADR-000028]]で導入したConnect-RPC基盤のPhase 1（Feed Stats）が完了し、Phase 2-3としてFeed List / Search エンドポイントの移行を実施した。
...
## 付録
- [[000034]] alt-frontend-sv Connect-RPC クライアント移行
- [[000310]] OGP 画像即時表示システム — 実装完了まとめ
