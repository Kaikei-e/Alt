---
title: rask-log サイドカーのネットワークアーキテクチャ再設計
date: 2026-01-10
status: accepted
tags: [logging, monitoring, rag, recap, search]
affected_services: [alt-backend, altctl, auth-hub, news-creator, nginx, pre-processor, rask-log-aggregator, rask-log-forwarder, search-indexer, tag-generator]
