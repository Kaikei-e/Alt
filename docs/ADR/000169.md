---
title: Tag Trail記事検索の改善（タグ名検索への変更）
date: 2026-02-04
status: accepted
tags: [backend, database, docker, rss, testing]
affected_services: [alt-backend, alt-frontend-sv]
aliases: [ADR-169, ADR-000169]
---
...
[[000167|ADR-167]]で実装したTag Trail機能において、タグをクリックしても同じ記事に繰り返しジャンプする問題が発生していた。
