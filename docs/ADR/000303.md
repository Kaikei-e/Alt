---
title: フィード登録時のユーザー自動購読と購読フィルターの修正
date: 2026-02-28
status: accepted
tags: [bugfix, connect-rpc, database, rss]
affected_services: [alt-backend]
aliases: [ADR-303, ADR-000303]
---
...
- [[000299]] `GetFeedIDByURL` のクエリ対象変更
- [[000300]] `feed_links.id` と `feeds.id` の混同修正
- [[000301]] `GetFeedIDByURL` の二重用途バグ修正
