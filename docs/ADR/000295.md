---
title: BFFストリーミングバイパス — io.ReadAll全バッファリングと30秒デッドラインの修正
date: 2026-02-28
status: accepted
tags: [connect-rpc, frontend, networking, rag, testing]
affected_services: [alt-backend, nginx, rag-orchestrator]
aliases: [ADR-295, ADR-000295]
---
# ADR-000295: BFFストリーミングバイパス — io.ReadAll全バッファリングと30秒デッドラインの修正

## ADR's STATUS

Accepted（[[000292|ADR-000292]]/[[000293|293]]の後続修正）

## CONTEXT

[[000289|ADR-289]]/[[000292|292]]/[[000293|293]]でnginx設定の最適化とrag-orchestratorへのハートビート機構を導入したが、フロントエンドで依然として `Error: [unknown] missing EndStreamResponse` が発生し続けていた。
...
- [[000292]] Augurストリーミング30秒タイムアウト修正（ハートビート導入）
- [[000293]] ハートビートをLLMストリーミングフェーズに拡張
