---
title: ClickHouse ログ基盤の包括的改善
date: 2026-01-15
status: accepted
tags: [database, logging, monitoring, rag]
affected_services: [alt-backend, news-creator, nginx, pre-processor, rag-orchestrator, rask-log-forwarder, recap-worker, tag-generator]
...
- [[000120]] 未対応サービスへのOTel準拠ロガー導入
- [[000315]] rask-log-forwarder ビジネスコンテキスト付与の総点検・修正
