---
title: "mq-hub: Redis Streams によるイベント駆動アーキテクチャの導入"
date: 2026-01-13
status: accepted
tags: [caching, connect-rpc, database, queue, search]
affected_services: [alt-backend, mq-hub, pre-processor, search-indexer, tag-generator]
