---
title: 内部サービス間通信の Connect-RPC 移行
date: 2026-01-10
status: accepted
tags: [api, backend, connect-rpc, docker, search]
affected_services: [alt-backend, alt-frontend-sv, auth-token-manager, pre-processor, search-indexer]
...
- [[000001]] Docker Compose によるマイクロサービス基盤
- [[000023]] Connect-RPC 採用（フロントエンド ↔ バックエンド）
- [[000068]] Connect-RPC をデフォルト通信プロトコルとして採用
