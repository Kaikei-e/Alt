---
title: Augur ChatフロントエンドをREST/SSEからConnect-RPCへ移行
date: 2026-01-29
status: accepted
tags: [connect-rpc, docker, migration, rag]
affected_services: [alt-backend, alt-frontend-sv, rag-orchestrator]
aliases: [ADR-156, ADR-000156]
---
...
- [[000155]] RAG用LLMをgpt-oss:20bからqwen3:14bへ移行（rag-orchestratorのモデル変更）
