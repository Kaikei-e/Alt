---
title: 検索機能のエラーハンドリング改善とスタック依存関係の明確化
date: 2026-01-07
status: accepted
tags: [authentication, connect-rpc, docker, search, testing]
affected_services: [alt-backend, alt-frontend, alt-frontend-sv, altctl, auth-hub, nginx, pre-processor, search-indexer, tag-generator]
...
なし
- [[000058]] Feature Model導入によるスタック依存関係の改善
- [[000060]] SvelteKit開発環境の最小構成スタック（altctl up dev）
