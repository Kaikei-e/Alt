---
title: Recap Job Status Dashboard 実装
date: 2026-01-17
status: accepted
tags: [api, connect-rpc, database, monitoring, recap]
affected_services: [alt-frontend-sv, recap-worker]
...
## APPENDIX
- [[000112]] Recap Job 手動トリガー機能
- [[000113]] Recap Job ステータス不整合の修正
- [[000114]] Recap Job ステータス履歴のイミュータブル化
- [[000115]] Recap Job Status ページのトリガーソース表示強化
- [[000116]] Start Job ボタン無効化が動作しない問題の修正
- [[000117]] Dispatch ステージのサブ進捗追跡改善
- [[000118]] Evidence ステージの進捗追跡と Classification フィルタリング
- [[000149]] Recap Job ステータス判定ロジックの修正
