---
title: RAG推論レベル動的選択による応答速度改善
date: 2025-12-30
status: accepted
tags: [ai, performance, rag]
affected_services: [rag-orchestrator]
...
2025年12月下旬、[[000023|ADR 000023]]のプロンプト最適化により、rag-orchestratorサービスのRAG回答品質は大幅に向上した。しかし、新たに重大なパフォーマンス問題が発覚した。

### 問題の詳細

**事象:**
[[000023|ADR 000023]]の実装後、回答品質は「非常に良くなった」（ユーザーフィードバック）が、システムが正常に動作しなくなった。
...
- **Reasoning Level**: `medium`（[[000023|ADR 000023]]で"low"から変更）
...
2. **ADRの副作用**
   - [[000023|ADR 000023]]の`Think: "medium"`変更がクエリ拡張に影響
...
- **更新日:** 2025年12月30日
- **関連ADR:**
  - [[000023|ADR 000023]]: RAGプロンプト最適化（本ADRの発端）
  - [[000022|ADR 000022]]: クエリ拡張の導入（影響を受けたコンポーネント）
- **影響を受けるコンポーネント:**
  - rag-orchestrator
