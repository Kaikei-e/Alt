---
title: Augur機能への Connect-RPC ストリーミングハンドラ追加
date: 2026-01-15
status: accepted
tags: [ai, api, connect-rpc, rag]
affected_services: []
...
- [[000090]] Re-ranking + Hybrid Search 導入
- [[000093]] LLM 使用ソースのみを返却する修正
...
- BM25 + Vector 検索の RRF 融合（[[000090|ADR 000090]]）
