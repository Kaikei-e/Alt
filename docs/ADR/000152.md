---
title: "Unified Ollama Model Configuration: COLD_START Prevention"
date: 2026-01-27
status: accepted
tags: [ai, docker]
affected_services: [news-creator, pre-processor, recap-evaluator]
aliases: [ADR-152, ADR-000152]
---
...
[[000140|ADR 140]] + [[000145|ADR 145]] の設計意図では、**全サービスが同一モデル (`gemma3-4b-8k`) を共有**して COLD_START を回避する想定だったが、各サービスのデフォルト値やハードコードが統一されていなかった。
...
- シンプルかつ確実
- 設定漏れのリスクを最小化
- [[000145|ADR 145]] の「8K × 2 スロット設計」に完全準拠
...
4. **[[000145|ADR 145]] 準拠**: 8K × 2 スロット設計の意図通りに動作
...
- [[000145]] 8K Context + OLLAMA_NUM_PARALLEL=2 設計
