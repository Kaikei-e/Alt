---
title: search-indexer Clean Architecture リファクタリング
date: 2026-02-06
status: accepted
tags: [authentication, caching, clean-architecture, connect-rpc, search]
affected_services: [news-creator, pre-processor, search-indexer]
aliases: [ADR-188, ADR-000188]
---
...
- [[000185]] news-creator / pre-processor キュー飽和問題の解決（指数バックオフパターンの参考）
- [[000190]] バックアップシステム堅牢化
- [[000191]] pre-processor 7フェーズ段階的リファクタリング
- [[000322]] search-indexer WaitForTask ポーリング間隔バグの修正
