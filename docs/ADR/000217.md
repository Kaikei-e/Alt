---
title: auth-token-manager トークン API 応答バグの修正 - サービス間トークン連携の復旧
date: 2026-02-10
status: accepted
tags: [api, authentication, bugfix, docker, testing]
affected_services: [auth-token-manager, pre-processor]
aliases: [ADR-217, ADR-000217]
---
