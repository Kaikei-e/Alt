---
title: Desktop検索UIの追加feed表示レイテンシ改善
date: 2026-02-11
status: accepted
tags: [docker, frontend, performance, search]
affected_services: [alt-backend, alt-frontend-sv]
aliases: [ADR-220, ADR-000220]
---
...
1. **500ms クールダウン**: [[000219|ADR-000219]] で追加された連鎖発火防止用タイマーが保守的すぎた
...
- 関連: [[000219|ADR-000219]]（本 ADR の前提となるクールダウン追加と検索クライアント改善）
- フロントエンドの遅延要因分析には `docker compose logs` によるタイムスタンプ比較を使用
- [[000221]] Desktop検索 Infinite Scroll の \"Loading more...\" 永続表示バグ修正
