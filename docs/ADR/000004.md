---
title: セキュリティ強化とKubernetes基盤の導入
date: 2025-12-28
status: accepted
tags: [monitoring, performance, rss, search, security]
affected_services: [alt-backend, alt-frontend, pre-processor, search-indexer, tag-generator]
