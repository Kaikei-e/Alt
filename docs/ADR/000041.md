---
title: Dockerfile セキュリティ・効率・ビルド速度の最適化
date: 2026-01-02
status: accepted
tags: [ai, docker, logging, rag, search]
affected_services: [alt-backend, alt-frontend, alt-frontend-sv, alt-perf, auth-hub, auth-token-manager, news-creator, pre-processor, rag-orchestrator, rask-log-aggregator, rask-log-forwarder, recap-evaluator, recap-subworker, recap-worker, search-indexer, tag-generator]
---
