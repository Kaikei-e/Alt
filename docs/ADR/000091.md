---
title: news-creator からの Ollama 分離
date: 2026-01-14
status: accepted
tags: [ai, clean-architecture, docker, testing]
...
- [[000121]] バッチサマリーチャンクサイズの環境変数化
- [[000157]] rask-log-forwarderをOTLP (OpenTelemetry Protocol) 準拠に拡張
