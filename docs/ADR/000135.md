---
title: TraceID/SpanID ログ出力問題の包括的修正（Phase 2）
date: 2026-01-21
status: accepted
tags: [connect-rpc, monitoring, queue, recap, search]
affected_services: [alt-backend, pre-processor, search-indexer]
aliases: [ADR-135, ADR-000135]
---
...
[[000134|ADR-134]] で pre-processor/main.go と search-indexer/rest/handler.go の TraceID/SpanID 問題を修正したが、調査の結果、他のレイヤーにも同様の問題が多数存在することが判明した。
