---
title: FetchUnreadFeedsListCursor の既読フィルタを user_reading_status テーブルに移行
date: 2026-01-01
status: withdrawn
tags: [backend, database, rss]
...
- [[000039]] フィード取得・既読処理におけるデータ整合性の確保 - サブクエリ化とOR検索
