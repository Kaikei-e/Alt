---
title: SwipeFeedCard お気に入りボタンをアイコンのみに変更
date: 2026-02-12
status: accepted
tags: [architecture]
affected_services: [alt-frontend-sv]
aliases: [ADR-236, ADR-000236]
---
...
[[000235|ADR-000235]] で SwipeFeedCard のフッターに「Favorite」ボタンを追加したが、3 ボタン均等配置（`flex-1`）のためモバイル画面でフッター横幅が不足し、「Summary」ボタンのテキストが見切れる問題が発生した。
...
2. **[[000235|ADR-000235]] からの設計変更**: [[000235|ADR-000235]] では「アイコン + ラベルの組み合わせ（認知しやすい）」を採用理由の一つとしていたが、モバイル画面幅の制約により方針を修正した

## APPENDIX

- [[000235]] SwipeFeedCard にお気に入りボタンを追加
- [[000237]] Favorites フィード一覧の重複キーによる Svelte reconcile クラッシュ修正
