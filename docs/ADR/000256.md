---
title: フィードソース除外フィルタ (Feeds ページ)
date: 2026-02-21
status: accepted
tags: [api, clean-architecture, connect-rpc, database, rss]
affected_services: [alt-backend, alt-frontend-sv, alt-perf]
aliases: [ADR-256, ADR-000256]
---
