---
title: 要約バッチと品質チェッカーの無限ループ解消
date: 2026-02-16
status: accepted
tags: [ai, queue, recap, rss, testing]
affected_services: [news-creator, pre-processor]
aliases: [ADR-251, ADR-000251]
---
...
- [[000247]] 要約パイプライン修正（カーソルページネーション導入）
- [[000249]] 要約パイプラインのイベント駆動化
- [[000250]] カーソルページネーション固着バグの修正
- [[000252]] フィード収集のレートリミット二重待機修正と pre-processor デッドコード削除
