---
title: "news-creator: Gemma3 QAT モデルへの移行"
date: 2026-01-21
status: accepted
tags: [ai, docker]
affected_services: [news-creator]
aliases: [ADR-136, ADR-000136]
---
...
**備考**: 60K 以上のコンテキストは RTX 4060 (8GB) では VRAM 制約により実用的ではない（[[000043|ADR-043]] と一致）。大規模入力には Map-Reduce 戦略を推奨。
