---
title: Lighthouse Performance 改善 Phase 3 — FCP/LCP 最適化と $effect ループ修正
date: 2026-02-27
status: accepted
tags: [connect-rpc, frontend, networking, performance]
affected_services: [nginx]
aliases: [ADR-279, ADR-000279]
---
...
### Phase 2 ([[000278|ADR-278]]) の結果

[[000278|ADR-278]] で SSR を有効化し、Performance スコアが 71 → 84 に改善された。
