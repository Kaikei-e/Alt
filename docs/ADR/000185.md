---
title: news-creator / pre-processor キュー飽和問題の解決
date: 2026-02-06
status: accepted
tags: [ai, api, monitoring, recap, testing]
affected_services: [news-creator, pre-processor, recap-worker]
aliases: [ADR-185, ADR-000185]
---
...
- [[000184]] recap-worker 3-day Recap 自動バッチデーモン化（キュー飽和が発生した直接的契機）
- [[000187]] alt-backend 基盤品質・ジョブシステム・パフォーマンス改善
