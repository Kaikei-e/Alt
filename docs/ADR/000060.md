---
title: SvelteKit開発環境の最小構成スタック（altctl up dev）
date: 2026-01-08
status: accepted
tags: [authentication, database, docker, frontend, search]
affected_services: [alt-backend, alt-frontend, alt-frontend-sv, altctl, auth-hub, nginx]
...
- [[000061]] フロントエンド専用開発環境（frontend-dev スタック）
