---
title: Docker Composeによるマイクロサービス基盤とクリーンアーキテクチャの採用
date: 2025-12-26
status: accepted
tags: [backend, clean-architecture, database, docker, networking]
affected_services: [alt-backend, alt-frontend, nginx]
...
- [[000027]] Article IDの3層統合とFeedDetailModalのUI改善
- [[000067]] 内部サービス間通信の Connect-RPC 移行
