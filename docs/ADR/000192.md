---
title: recap-worker Rust 2024 モダナイゼーション
date: 2026-02-07
status: accepted
tags: [docker, monitoring, performance, recap, refactoring]
affected_services: [pre-processor, recap-worker]
aliases: [ADR-192, ADR-000192]
---
...
- [[000191]] pre-processor 7 フェーズ段階的リファクタリング (同一プロジェクト内の Go サービスにおける同様の段階的改善)
- [[000193]] rask-log-aggregator Clean Architecture リファクタリング + バッチバッファリング
