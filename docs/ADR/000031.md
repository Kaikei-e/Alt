---
title: "altctl: Docker Composeスタックオーケストレーションツールの導入"
date: 2025-12-31
status: accepted
tags: [authentication, logging, rag, recap, search]
affected_services: [alt-backend, altctl, auth-hub, auth-token-manager, news-creator, nginx, pre-processor, rag-orchestrator, rask-log-forwarder, recap-subworker, recap-worker, search-indexer, tag-generator]
...
- [[000311]] OGP 画像プロキシ 502 エラーおよびレートリミッター連鎖障害の修正
- [[000313]] FetchArticleContent 外部 HTTP エラーの適切なステータスコード変換
