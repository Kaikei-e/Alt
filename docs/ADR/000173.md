---
title: Tag Trail 初期フィードカードのオンザフライタグ生成
date: 2026-02-04
status: accepted
tags: [connect-rpc, docker, queue, rss, testing]
affected_services: [alt-backend, mq-hub]
aliases: [ADR-173, ADR-000173]
---
...
| コンポーネント | オンザフライ生成 | 状態 |
|--------------|----------------|------|
| `FetchArticleTagsGateway` | あり ([[000168|ADR-168]]) | mq-hub連携済み |
...
- [[000167]] Tag Trail基本設計
- [[000168]] オンザフライタグ生成（Gateway実装）
- [[000169]] タグ名による横断検索
- [[000170]] Tag Trail connect-rpc移行
- [[000171]] リアルタイムタグ反映 (Server Streaming)
- [[000172]] CJKテキスト対応とフィード解決ロジック改善
