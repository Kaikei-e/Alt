---
title: スケーラブルコンテンツ処理パイプラインの構築
date: 2025-12-28
status: accepted
tags: [authentication, database, monitoring, rss, search]
affected_services: [news-creator, pre-processor, search-indexer, tag-generator]
