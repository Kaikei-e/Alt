---
title: Trend Stats API のマルチテナント分離漏れの修正
date: 2026-01-13
status: accepted
tags: [connect-rpc]
affected_services: [alt-backend, alt-frontend]
...
- [[000085]] Connect-RPC Proto パッケージ名の不一致による検索エラーの修正
- [[000087]] Ollama 0.13.x Docker 環境での CUDA 初期化エラーの解決
