...
date: 2026-02-06
status: accepted
tags: [clean-architecture, monitoring, rag, recap, search]
affected_services: [altctl, search-indexer]
aliases: [ADR-190, ADR-000190]
---
# バックアップシステム堅牢化
...
- [[000188]] search-indexer Clean Architecture リファクタリング (テスト駆動開発パターンの参考)
