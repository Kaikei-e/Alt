---
title: "Desktop検索 Infinite Scroll の \"Loading more...\" 永続表示バグ修正"
date: 2026-02-11
status: accepted
tags: [bugfix, connect-rpc, docker, performance]
affected_services: [alt-frontend-sv]
aliases: [ADR-221, ADR-000221]
---
...
- 前提: [[000219|ADR-000219]]（クールダウン追加と検索クライアント改善）、[[000220|ADR-000220]]（レイテンシ改善の初期対応）
- 本 ADR は [[000220|ADR-000220]] で残された observer 再作成コストの改善を含む
- [[000222]] Desktop検索 Infinite Scroll を `bind:this` + `$effect` パターンに移行
- [[000224]] Svelte 5 $effect 内 isLoading ガード除去による初回ローディングスピナー永続表示バグの修正
