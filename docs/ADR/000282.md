---
title: alt-backend SQL 総点検 — 正確性バグ修正・パフォーマンス改善・インデックス最適化
date: 2026-02-27
status: accepted
tags: [clean-architecture, database, rag, recap, rss]
affected_services: [alt-backend]
aliases: [ADR-282, ADR-000282]
---
...
## 付録
- [[000283]] article_tags JOIN ボトルネックに対する LATERAL サブクエリ最適化
