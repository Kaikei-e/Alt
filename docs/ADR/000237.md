---
title: Favorites フィード一覧の重複キーによる Svelte reconcile クラッシュ修正
date: 2026-02-13
status: accepted
tags: [api, backend, clean-architecture, performance, rss]
affected_services: [alt-backend]
aliases: [ADR-237, ADR-000237]
---
...
[[000235|ADR-000235]]/[[000236|000236]] で実装した Favorites ページ (`/sv/feeds/favorites`) をブラウザで開くと、以下のランタイムエラーが発生した：
...
これは [[000228|ADR-000228]]/[[000229|000229]] で修正した Svelte 5 `{#each}` reconcile の重複キー問題と同一の原因である。
...
- [[000228]] 検索結果の重複 ID による Svelte reconcile クラッシュ修正
- [[000235]] SwipeFeedCard にお気に入りボタンを追加
- [[000236]] SwipeFeedCard お気に入りボタンをアイコンのみに変更
- [[000238]] プレゼンテーション層 UUID 生成による Svelte keying ID のドメイン分離
- [[000239]] SwipeFeedCard Favorite ボタンのモバイル動作不良修正
