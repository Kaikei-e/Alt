---
title: Grafana/Prometheus 監視基盤の総点検と致命的バグ修正
date: 2026-02-28
status: accepted
tags: [api, database, logging, monitoring, queue]
affected_services: [alt-backend, mq-hub, nginx, pre-processor, rask-log-forwarder, recap-subworker, recap-worker]
aliases: [ADR-286, ADR-000286]
---
