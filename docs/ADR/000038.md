---
title: REST API から Connect-RPC への完全移行
date: 2026-01-01
status: accepted
tags: [api, connect-rpc, performance, rag, testing]
...
- [[000029]] Connect-RPC統一戦略 - 初期のConnect-RPC移行決定
- [[000037]] Morning Letter機能 - ストリーミングRPCの実装例
- [[000039]] フィード取得・既読処理におけるデータ整合性の確保
