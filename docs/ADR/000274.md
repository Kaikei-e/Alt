---
title: OGP 画像プロキシ — ドメイン許可リストを article_heads から拡張
date: 2026-02-27
status: accepted
tags: [backend, caching, docker, rss, testing]
affected_services: [alt-backend, nginx]
aliases: [ADR-274, ADR-000274]
---
...
[[000273|ADR-000273]] で OGP 画像プロキシを有効化したが、実際のリクエストの大半が **403 "domain not allowed"** で失敗していた。
...
| [[000273|ADR-000273]] | プロキシ有効化のための Docker Secret 設定 |
| [[000274|ADR-000274]] (本 ADR) | ドメイン許可リストを `article_heads` から拡張 |
