---
title: "ADR-124/125実装完了: Trace Context伝搬問題の修正"
date: 2026-01-18
status: accepted
tags: [logging, monitoring, queue, rag, search]
affected_services: [alt-backend, auth-hub, mq-hub, pre-processor, rag-orchestrator, rask-log-aggregator, rask-log-forwarder, search-indexer]
aliases: [ADR-127, ADR-000127]
---
...
[[000124|ADR-124]]/[[000125|125]]で「Accepted」となっていたtrace context伝搬対応について、実装調査を行った結果、複数の未実装箇所が発見された。GrafanaダッシュボードでTraceId/SpanIdが全てゼロ表示される問題の根本原因として、以下の3つが特定された。
...
- [[000122]] Grafana Trace/Log表示問題の修正
- [[000123]] otelslogブリッジのTrace Context属性フォールバック対応
- [[000124]] ログパイプラインのTrace Context伝搬完全対応
- [[000125]] Grafana/ClickHouse連携のためのtrace_id/span_id伝搬対応
- [[000129]] rask-log-aggregator: OTLP HTTP専用ポート (4318) の追加
