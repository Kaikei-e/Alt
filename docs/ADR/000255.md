---
title: K6 ロードテスト導入 (alt-perf)
date: 2026-02-21
status: accepted
tags: [authentication, backend, database, docker, monitoring]
affected_services: [alt-backend, alt-frontend-sv, alt-perf, altctl, nginx]
aliases: [ADR-255, ADR-000255]
---
...
- [[000254]] alt-frontend-sv E2E テスト無限スクロールループの修正
