---
title: OpenTelemetry HTTP Span Status 設定の実装
date: 2026-01-21
status: accepted
tags: [authentication, database, docker, search, testing]
affected_services: [alt-backend, auth-hub, pre-processor, search-indexer]
aliases: [ADR-133, ADR-000133]
---
