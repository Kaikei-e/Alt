---
title: auth-hub Clean Architecture リファクタリングとセキュリティ強化
date: 2026-02-07
status: accepted
tags: [authentication, caching, clean-architecture, database, security]
affected_services: [auth-hub, nginx]
aliases: [ADR-197, ADR-000197]
---
