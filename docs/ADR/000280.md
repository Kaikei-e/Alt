---
title: OGP Image Proxy リファクタリング — 関心の分離と 502 エラー修正
date: 2026-02-27
status: accepted
tags: [backend, bugfix, refactoring]
affected_services: [alt-backend, alt-frontend-sv, nginx]
aliases: [ADR-280, ADR-000280]
---
...
[[000276|ADR-276]]〜279 の実装で OGP 画像プロキシ機能が追加された。HMAC 署名付きプロキシ URL を生成し、外部 OGP 画像をバックエンド経由で配信する仕組みである。しかし、実運用で以下の 3 つの問題が発覚した。
