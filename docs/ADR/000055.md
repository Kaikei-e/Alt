---
title: pre-processorエラーハンドリング包括的見直し：alt-backendパターン踏襲
date: 2026-01-07
status: accepted
tags: [clean-architecture, database, refactoring]
...
[[000054|ADR 54]]で確立した `AppContextError` パターンをpre-processorに適用：
...
- [[000054]] alt-backendエラーハンドリング包括的見直し
