---
title: OGP 画像表示遅延の修正 — Svelte リアクティビティ + バックエンド軽量クエリ
date: 2026-02-26
status: accepted
tags: [frontend, refactoring, testing]
affected_services: [alt-backend, alt-frontend-sv]
aliases: [ADR-269, ADR-000269]
---
...
[[000268|ADR-000268]] で OGP 画像取得をバックエンド抽出方式に移行し、`ArticlePrefetcher` の `ogImageCache` で管理する構成とした。プリフェッチチェーン自体は正しく動作し 5 枚先まで取得できていたが、**取得結果が UI に反映されない**問題が発生した。
...
| 項目 | [[000268|ADR-000268]] | [[000269|ADR-000269]] (本 ADR) |
|------|-----------|---------------------|
