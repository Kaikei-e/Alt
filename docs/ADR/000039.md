---
title: フィード取得・既読処理におけるデータ整合性の確保
date: 2026-01-01
status: accepted
tags: [connect-rpc, database, rss]
...
- [[000038]] REST API から Connect-RPC への完全移行 - APIの統一戦略
- [[000040]] FetchUnreadFeedsListCursor の既読フィルタを user_reading_status テーブルに移行
