---
title: "alt-backend責務分析: マイクロサービスベストプラクティスとの比較"
date: 2026-02-05
status: accepted
tags: [authentication, connect-rpc, rag, recap, search]
affected_services: [alt-backend, alt-frontend-sv, auth-hub, mq-hub, pre-processor, rag-orchestrator, recap-worker, search-indexer]
aliases: [ADR-180, ADR-000180]
---
