---
title: "tag-generator の CPU 浪費を 3 層で修正 (1683% → < 1%)"
date: 2026-02-27
status: accepted
tags: [ai, api, database, rag]
affected_services: [alt-backend, rag-orchestrator, tag-generator]
aliases: [ADR-276, ADR-000276]
---
...
| ADR | 内容 |
|-----|------|
| [[000275|ADR-000275]] | rag-orchestrator の CPU 浪費修正（同種の問題） |
| [[000276|ADR-000276]] (本 ADR) | tag-generator の CPU 浪費修正 |
