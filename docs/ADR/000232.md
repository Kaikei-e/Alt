---
title: TTS サーバーストリーミング化・ボイス変更・速度変更
date: 2026-02-11
status: accepted
tags: [api, connect-rpc, recap, testing]
affected_services: [alt-frontend-sv]
aliases: [ADR-232, ADR-000232]
---
...
[[000231|ADR-231]] で Recap ページの TTS 音読機能を unary RPC (`Synthesize`) で実装した。運用で以下の課題が判明した。
...
**After ([[000232|ADR-232]]: streaming)**
```
