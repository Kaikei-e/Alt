---
title: Recap Job ステータス履歴のイミュータブル化
date: 2026-01-17
status: accepted
tags: [database, frontend, recap]
...
[[000113|ADR-113]] で対処した「最新のJobが失敗しているのにCompletedになる」バグの根本原因を解消するため、ジョブステータス管理をイミュータブルなイベントソーシングパターンに移行する。
...
- [[000109]] Recap Job Status Dashboard 実装
