---
title: Streaming Semaphore Leak 修正 (Defense-in-Depth)
date: 2026-02-15
status: accepted
tags: [ai, monitoring]
affected_services: [news-creator]
aliases: [ADR-243, ADR-000243]
---
...
[[000142|ADR-142]] で導入した Eager Semaphore Acquisition パターンにおいて、async generator の `finally` ブロックが信頼できないケースが存在した。
...
4. **非破壊的**: 既存の Eager Acquisition パターン ([[000142|ADR-142]]) の設計を変更せず、クリーンアップのみ強化
