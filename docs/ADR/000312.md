---
title: RegisterFeedsUsecase から mq-hub への ArticleCreated イベント発行
date: 2026-03-02
status: accepted
tags: [caching, queue, rag, rss, search]
affected_services: [alt-backend, mq-hub, pre-processor, rag-orchestrator, search-indexer, tag-generator]
aliases: [ADR-312, ADR-000312]
---
...
- [[000083]] Redis Streams イベント駆動化（mq-hub 導入）
- [[000303]] フィード登録時のユーザー自動購読（`autoSubscribeUser` パターンの前例）
