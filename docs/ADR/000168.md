...
date: 2026-02-04
status: accepted
tags: [api, caching, connect-rpc, queue, testing]
affected_services: [alt-backend, mq-hub, tag-generator]
aliases: [ADR-168, ADR-000168]
---
# オンザフライタグ生成の実装
...
Tag Trail機能（[[000167|ADR-167]]）の導入により、記事閲覧時にタグを即座に表示する必要が生じた。しかし既存のタグ生成はバッチ処理のみであり、以下の課題があった：
...
- [[000169]] Tag Trail記事検索の改善（タグ名検索への変更）
- [[000170]] Tag Trail connect-rpc 完全移行
- [[000171]] Tag Trail リアルタイムタグ反映 (Server Streaming)
- [[000172]] Tag Trail CJK テキスト対応とフィード解決ロジック改善
- [[000173]] Tag Trail 初期フィードカードのオンザフライタグ生成
- [[000174]] Tag Trail FetchRandomFeed レスポンスへのタグ統合
- [[000175]] Tag Trail フィード表示時の記事オンデマンド取得
- [[000176]] tag-generator 日本語タグ生成品質改善
- [[000177]] Tag Trail Desktop UI 改善
