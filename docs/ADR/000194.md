---
title: alt-frontend-sv インクリメンタルリファクタリング
date: 2026-02-07
status: accepted
tags: [authentication, clean-architecture, connect-rpc, database, recap]
affected_services: [alt-frontend-sv, auth-hub, pre-processor, rask-log-aggregator]
aliases: [ADR-194, ADR-000194]
---
...
- [[000191]] pre-processor 段階的リファクタリング (Go サービスにおける同様の構造改善)
- [[000193]] rask-log-aggregator Clean Architecture リファクタリング (Rust サービスにおける段階的改善)
