---
title: "rask-log-aggregator: OTLP HTTP専用ポート (4318) の追加"
date: 2026-01-19
status: accepted
tags: [api, docker, logging, monitoring, networking]
affected_services: [alt-backend, rask-log-aggregator]
aliases: [ADR-129, ADR-000129]
---
...
- [[000127]] OTLPエンドポイントポート修正 (9600 → 4318)
- [[000128]] trace_id/span_id消失バグの修正
