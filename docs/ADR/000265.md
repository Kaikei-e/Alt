---
title: Quality Check バッチジョブによる BE スロット独占の解消
date: 2026-02-25
status: accepted
tags: [ai, backend, performance, queue, rss]
affected_services: [alt-backend, alt-frontend-sv, news-creator, pre-processor]
aliases: [ADR-265, ADR-000265]
---
...
[[000264|ADR-000264]] で LIFO スケジューリングを導入し、スワイプフィードの体感レイテンシを改善した。しかし、依然として非同期要約リクエストが「詰まる」現象が発生していた。
...
- [[000334]] Quality Check による BE スロット競合の解消: 要約キュー優先制御
- [[000335]] エラー伝搬バグ修正: pre-processor エラーの UNKNOWN_ERROR 変換と運用ログノイズ削減
