---
title: Connect-RPC Streaming 完全移行
date: 2025-12-31
status: accepted
tags: [api, connect-rpc, migration, rag]
affected_services: []
...
[[000034|ADR-000034]]でConnect-RPCクライアント移行が完了したが、Streamingエンドポイントは「完全移行は別途」として保留されていた。具体的には以下のエンドポイントがREST SSEのままだった：
...
- [[000032]] Connect-RPC Phase 4-6（Streaming文書化）
- [[000034]] Connect-RPCクライアント移行（本ADRの前提）
