---
title: tag-generator 7 Phase リファクタリング
date: 2026-02-06
status: accepted
tags: [api, clean-architecture, docker, refactoring]
affected_services: [tag-generator]
aliases: [ADR-186, ADR-000186]
---
...
- [[000176]] KeyBERT 日本語スコアリング修正（Phase 5 で分割対象となった Japanese extractor の原型）
