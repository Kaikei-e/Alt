...
date: 2026-01-18
status: accepted
tags: [database, docker, logging, monitoring, search]
affected_services: [alt-backend, auth-hub, pre-processor, rask-log-aggregator, rask-log-forwarder, search-indexer]
aliases: [ADR-122, ADR-000122]
---
...
- [[000128]] rask-log-forwarder: trace_id/span_id消失バグの修正
