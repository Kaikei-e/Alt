---
title: pre-processor-db 分離 — alt-db 依存の完全解消
date: 2026-02-15
status: accepted
tags: [clean-architecture, connect-rpc, database, queue, search]
affected_services: [alt-backend, pre-processor, search-indexer, tag-generator]
aliases: [ADR-246, ADR-000246]
---
...
[[000241|ADR-000241]] で「Shared Database アンチパターンの解消」方針を決定し、search-indexer・tag-generator は Connect-RPC 経由へ移行済み。しかし pre-processor は以下 5 テーブルを alt-db 上に直接保持しており、alt-db への依存が残存していた。
