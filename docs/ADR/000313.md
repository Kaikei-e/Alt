---
title: FetchArticleContent 外部 HTTP エラーの適切なステータスコード変換
date: 2026-03-02
status: accepted
tags: [connect-rpc, docker, migration, queue, testing]
affected_services: [alt-backend, mq-hub]
aliases: [ADR-313, ADR-000313]
---
...
[[000311|ADR-311]] の OGP 画像プロキシ修正後、本番環境の HAR ファイル（133 エントリ）を再解析した結果、FetchArticleContent エンドポイントに 1 件の 500 Internal Server Error が検出された。
...
- [[000031]] 1 : OGP 画像プロキシ 502 エラーおよびレートリミッター連鎖障害の修正
- [[000031]] 2 : RegisterFeedsUsecase から mq-hub への ArticleCreated イベント発行
