---
title: SwipeFeedCard Favorite ボタンのモバイル動作不良修正
date: 2026-02-13
status: accepted
tags: [database, rss, testing]
affected_services: [alt-backend, alt-frontend-sv]
aliases: [ADR-239, ADR-000239]
---
...
[[000235|ADR-000235]]/[[000236|000236]] で SwipeFeedCard に追加した Favorite ボタンが、モバイル環境で正常に動作しなかった。症状は「スピナー表示後に元の状態に戻る」。
...
- [[000235]] SwipeFeedCard Favorite ボタン実装
- [[000236]] SwipeFeedCard Favorite ボタン UI 設計
- [[000237]] Favorites フィード一覧の重複キー修正
