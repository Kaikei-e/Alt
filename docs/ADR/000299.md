---
title: alt-backend 既存バグ4件の修正 — NULL FeedID・重複サブクエリ・テーブル参照誤り・Prometheus 404
date: 2026-02-28
status: accepted
tags: [api, backend, bugfix, monitoring, rss]
affected_services: [alt-backend]
aliases: [ADR-299, ADR-000299]
---
...
[[000298|ADR-000298]]（proto 型リネーム）の適用後に alt-backend のランタイムログを調査した結果、proto リネーム起因のエラーは 0 件であった。しかし、以下の既存バグ 4 件が継続的にエラーログを発生させていた。
