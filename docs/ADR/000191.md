---
title: pre-processor 7フェーズ段階的リファクタリング
date: 2026-02-07
status: accepted
tags: [caching, clean-architecture, queue, rss, search]
affected_services: [news-creator, pre-processor, search-indexer]
aliases: [ADR-191, ADR-000191]
---
...
- [[000188]] search-indexer Clean Architecture リファクタリング (同一アーキテクチャパターンの先行実装)
- [[000192]] recap-worker Rust 2024 モダナイゼーション
