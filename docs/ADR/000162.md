---
title: Evening Pulse スキーマ増分マイグレーション
date: 2026-01-31
status: accepted
tags: [database]
affected_services: []
aliases: [ADR-162, ADR-000162]
---
...
[[000161|ADR-161]]で実装したEvening Pulse v4.0のDBスキーマにおいて、`pulse_generations`テーブルの`target_date`カラムが本番環境で欠落していた。
...
- [[000161]] Evening Pulse v4.0 実装
- [[000163]] Evening Pulse UI Enhancement: 代表記事・エンティティ表示
