...
[[000049|ADR-000049]]で導入したURL正規化のゼロトラスト原則が、一部のコードパスに適用されていないことが判明した。
...
| コードパス | 正規化 | 状態 |
|-----------|--------|------|
| `RegisterFeedsGateway.RegisterFeeds()` | あり | [[000049|ADR-000049]]で対応済み |
...
- [[000049]] MarkAsRead API 404エラー修正 - URL正規化のゼロトラスト実装
- [[000089]] search-indexer の Redis Streams Consumer 統合
