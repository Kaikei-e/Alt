---
title: alt-frontend-sv 認証フック無限リダイレクトループの修正：パブリックルート処理とURL二重エンコーディング問題
date: 2025-12-28
status: accepted
tags: [authentication, database, frontend, security, testing]
affected_services: [alt-frontend, alt-frontend-sv]
---
