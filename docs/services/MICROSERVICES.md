...
| alt-backend | Go 1.24+ (Echo) | 9000, 9101 | core.yaml | `/v1/health` | Knowledge Home (event sourcing, projector, backfill, reproject, SLO) |
| alt-butterfly-facade | Go 1.25+ | 9250 | bff.yaml | `/alt-butterfly-facade healthcheck` | Knowledge Home Admin API routing |
