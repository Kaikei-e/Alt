...
| tts-speaker | Python 3.14 (Starlette + Kokoro) | 9700 | compose.tts.yaml | `/health` |
...
| Service | Language | Port(s) | Compose File | Health Endpoint |
|---------|----------|---------|--------------|-----------------|
| acolyte-orchestrator | Python 3.14+ (Starlette + LangGraph) | 8090 | acolyte.yaml | `/health` |
...
| acolyte-db | PostgreSQL 18 | 5438 | acolyte.yaml | `pg_isready` |
