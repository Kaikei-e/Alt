...
# and recorded. PACT_DISABLE_PENDING=true opts out; WIP activates only
# when PACT_INCLUDE_WIP_SINCE is a valid ISO 8601 date (usually the
# broker onboarding date). Mirrors the Go providers' env contract so
# pact-check.sh can flip one variable and cover every service.
