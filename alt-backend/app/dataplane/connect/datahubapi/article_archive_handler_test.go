...
func newArticleHandler(f articleFakes) (*Handler, articleFakes) {
	...
	WithArticleCapabilities(f.write, f.read, f.backfill)(h)
	return h, f
}
...
func TestWithArticleCapabilitiesRejectsNilCollaborators(t *testing.T) {
	read := &fakeArticleReadPort{}
	write := &fakeArticleWritePort{}
	backfill := &fakeKnowledgeBackfillPort{}
	...
	tests := []struct {
		...
		{"nil article write", func() { WithArticleCapabilities(nil, read, backfill) }},
		{"nil article read", func() { WithArticleCapabilities(write, nil, backfill) }},
		{"nil knowledge backfill", func() { WithArticleCapabilities(write, read, nil) }},
	}
...
func TestArchiveArticle_PassesOwnerThrough(t *testing.T) {
	...
	h, f := newArticleHandler(articleFakes{write: &fakeArticleWritePort{
...
func TestArchiveArticle_RejectsBadRequests(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			h, _ := newArticleHandler(articleFakes{})
...
func TestArchiveArticle_PropagatesFailureAsInternal(t *testing.T) {
	h, _ := newArticleHandler(articleFakes{write: &fakeArticleWritePort{err: errors.New("tx aborted")}})
...
func TestSaveArticleHead_Succeeds(t *testing.T) {
	og := &fakeOgImagePort{}
	h, _ := newMediaHandler(mediaFakes{ogImage: og})
...
func TestSaveArticleHead_RequiresArticleID(t *testing.T) {
	h, _ := newMediaHandler(mediaFakes{})
...
func TestGetArticleByURL_ScopeIsChosenByTheCaller(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			h, f := newArticleHandler(articleFakes{read: &fakeArticleReadPort{
...
func TestGetArticleByURL_MissLeavesTheFieldUnset(t *testing.T) {
	h, _ := newArticleHandler(articleFakes{read: &fakeArticleReadPort{content: nil}})
...
func TestBatchGetArticlesByURLs_OmitsMisses(t *testing.T) {
	h, _ := newArticleHandler(articleFakes{read: &fakeArticleReadPort{
		byURL: map[string]*domain.ArticleContent{
...
func TestListArticlesCursor_FirstPageHasNoCursor(t *testing.T) {
	h, f := newArticleHandler(articleFakes{})
...
func TestListArticleIDsCursor(t *testing.T) {
	id := uuid.New()
	h, f := newArticleHandler(articleFakes{read: &fakeArticleReadPort{ids: []uuid.UUID{id}}})
...
func TestGetLatestArticleByFeedID_MissLeavesTheFieldUnset(t *testing.T) {
	feedID := uuid.New()
	h, f := newArticleHandler(articleFakes{read: &fakeArticleReadPort{content: nil}})
...
func TestLookupArticleURL_UntitledArticleKeepsItsURL(t *testing.T) {
	h, _ := newArticleHandler(articleFakes{read: &fakeArticleReadPort{url: "https://example.com/untitled"}})
...
func TestLookupArticleURL_ForeignArticleIsEmptyNotNotFound(t *testing.T) {
	h, _ := newArticleHandler(articleFakes{read: &fakeArticleReadPort{url: ""}})
...
func TestCountBackfillArticles(t *testing.T) {
	h, _ := newArticleHandler(articleFakes{backfill: &fakeKnowledgeBackfillPort{articleCount: 4242}})
...
func TestListBackfillArticles_FirstPageAndKeyset(t *testing.T) {
	...
	h, f := newArticleHandler(articleFakes{backfill: &fakeKnowledgeBackfillPort{
		articles: []domain.KnowledgeBackfillArticle{{
...
func TestCountBackfillSummaryTitles(t *testing.T) {
	h, _ := newArticleHandler(articleFakes{backfill: &fakeKnowledgeBackfillPort{titleCount: 7}})
