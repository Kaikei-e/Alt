...
func TestMarkFeedReadContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/MarkFeedRead"),
			Headers: jsonHeaders(),
...
func TestMarkArticleReadContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/MarkArticleRead"),
			Headers: jsonHeaders(),
			Body: map[string]interface{}{
...
func TestGetReadFeedIDsContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/GetReadFeedIDs"),
			Headers: jsonHeaders(),
			Body: map[string]interface{}{
				"userId":  readStateUserID,
...
func TestGetAllReadFeedIDsContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/GetAllReadFeedIDs"),
			Headers: jsonHeaders(),
...
func TestGetUserSubscribedFeedLinkIDsContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/GetUserSubscribedFeedLinkIDs"),
			Headers: jsonHeaders(),
			Body:    map[string]interface{}{"userId": readStateUserID},
		}).
		WithCompleteResponse(consumer.Response{
...
func TestListSubscriptionsContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/ListSubscriptions"),
			Headers: jsonHeaders(),
			Body:    map[string]interface{}{"userId": readStateUserID},
		}).
		WithCompleteResponse(consumer.Response{
...
func TestSubscribeContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/Subscribe"),
			Headers: jsonHeaders(),
			Body: map[string]interface{}{
				"userId":     readStateUserID,
...
func TestUnsubscribeContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/Unsubscribe"),
			Headers: jsonHeaders(),
			Body: map[string]interface{}{
				"userId":     readStateUserID,
				"feedLinkId": readStateLinkID,
...
func TestAddFavoriteFeedContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/AddFavoriteFeed"),
			Headers: jsonHeaders(),
			Body: map[string]interface{}{
				"feedUrl": readStateFeedURL,
				"userId":  readStateUserID,
...
func TestRemoveFavoriteFeedNotFoundContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/RemoveFavoriteFeed"),
			Headers: jsonHeaders(),
			Body: map[string]interface{}{
				"feedUrl": readStateMissingURL,
				"userId":  readStateUserID,
...
func TestGetArticleTagsEmptyContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/GetArticleTags"),
			Headers: jsonHeaders(),
...
func TestGetFeedTagsContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/GetFeedTags"),
			Headers: jsonHeaders(),
			Body: map[string]interface{}{
...
func TestUpsertArticleTagsContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/UpsertArticleTags"),
			Headers: jsonHeaders(),
			Body: map[string]interface{}{
...
func TestGetTagCooccurrencesContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/GetTagCooccurrences"),
			Headers: jsonHeaders(),
...
func TestSearchTagsByPrefixContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/SearchTagsByPrefix"),
			Headers: jsonHeaders(),
			Body: map[string]interface{}{
				"prefix": "AI",
				"limit":  10,
...
func TestGetTagArticleCountsContract(t *testing.T) {
	...
	err := mockProvider.
		...
		WithCompleteRequest(consumer.Request{
			Method:  "POST",
			Path:    matchers.String("/services.datahub.v1.DataHubService/GetTagArticleCounts"),
			Headers: jsonHeaders(),
			Body: map[string]interface{}{
				"userId": readStateUserID,
