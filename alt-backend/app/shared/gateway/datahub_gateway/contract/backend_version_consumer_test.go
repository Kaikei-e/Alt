...
// Pact CDC: alt-backend → alt-data-hub, versioned artifacts
// (ADR-000954 Wave 3 batch 5, capability catalog §2.K).
//
// One consumer, like the read-state file: nothing here runs on a scheduler.
// Versions are appended when something is summarised or tagged.
//
