...
//
//	mockgen -source=client.go -destination=../../mocks/mock_auth_driver.go -package=mocks
//
...
func (m *MockAuthClient) ValidateSessionWithCookie(ctx context.Context, cookieHeader string) (*auth.SessionValidationResponse, error) {
	m.ctrl.T.Helper()
