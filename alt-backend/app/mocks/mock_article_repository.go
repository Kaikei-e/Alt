...
// Source: fetch_article_usecase.go
//
// Generated by this command:
//
//	mockgen -source=fetch_article_usecase.go -destination=../../mocks/mock_article_repository.go -package=mocks
//
...
func (m *MockArticleUsecase) FetchCompliantArticle(ctx context.Context, articleURL *url.URL, userContext domain.UserContext) (string, error) {
	m.ctrl.T.Helper()
