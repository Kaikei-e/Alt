...
// Source: ./alt-backend/app/port/opml_port/opml_port.go
//
// Generated by this command:
//
//	mockgen -source=./alt-backend/app/port/opml_port/opml_port.go -destination=./alt-backend/app/mocks/mock_opml_port.go -package=mocks ExportOPMLPort
//
