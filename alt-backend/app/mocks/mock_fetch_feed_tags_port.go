...
// Source: port/fetch_feed_tags_port/fetch_feed_tags_port.go
//
// Generated by this command:
//
//	mockgen -source=port/fetch_feed_tags_port/fetch_feed_tags_port.go -destination=mocks/mock_fetch_feed_tags_port.go -package=mocks
//
