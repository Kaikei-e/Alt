...
// Source: ./alt-backend/app/port/internal_article_port/port.go
//
// Generated by this command:
//
//	mockgen -source=./alt-backend/app/port/internal_article_port/port.go -destination=./alt-backend/app/mocks/mock_internal_article_port.go -package=mocks ListArticlesWithTagsPort
//
...
import (
	internal_article_port "alt/dataplane/port/internal_article_port"
	context "context"
	reflect "reflect"
	time "time"
