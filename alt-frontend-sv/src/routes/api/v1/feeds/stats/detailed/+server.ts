...
export const GET: RequestHandler = async ({ request }) => {
	...
	const backendEndpoint = `${BACKEND_BASE_URL}/v1/feeds/stats/detailed`;
	...
	try {
		...
		console.log(`[API Proxy] Fetching detailed stats from ${backendEndpoint}`);
		...
		console.error("Error in /api/v1/feeds/stats/detailed:", error);
