...
export const file_alt_preprocessor_v2_preprocessor: GenFile =
	/*@__PURE__*/
	fileDesc(
		"",
	);
...
export type SummarizeQueueRequest =
	Message<"alt.preprocessor.v2.SummarizeQueueRequest"> & {
		/**
		 * Article ID (required)
		 *
		 * @generated from field: string article_id = 1;
...
export type SummarizeQueueResponse =
	Message<"alt.preprocessor.v2.SummarizeQueueResponse"> & {
		/**
		 * Created job ID
		 *
...
export type SummarizeStatusRequest =
	Message<"alt.preprocessor.v2.SummarizeStatusRequest"> & {
		/**
...
export type SummarizeStatusResponse =
	Message<"alt.preprocessor.v2.SummarizeStatusResponse"> & {
		/**
		 * Job ID
		 *
		 * @generated from field: string job_id = 1;
