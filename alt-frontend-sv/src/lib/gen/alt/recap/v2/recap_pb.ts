...
export const file_alt_recap_v2_recap: GenFile = /*@__PURE__*/
  fileDesc("");
 ...
 *
 * @generated from message alt.recap.v2.ListRecapArticlesRequest
 */
export type ListRecapArticlesRequest = Message<"alt.recap.v2.ListRecapArticlesRequest"> & {
  /**
   ...
   *
   * @generated from field: optional string lang_hint = 6;
   */
  langHint?: string;
};

/**
 * Describes the message alt.recap.v2.ListRecapArticlesRequest.
 * Use `create(ListRecapArticlesRequestSchema)` to create a new message.
 */
export const ListRecapArticlesRequestSchema: GenMessage<ListRecapArticlesRequest> = /*@__PURE__*/
  messageDesc(file_alt_recap_v2_recap, 21);

/**
 * RecapArticleRange echoes the window bounds in the response
 *
 * @generated from message alt.recap.v2.RecapArticleRange
 */
export type RecapArticleRange = Message<"alt.recap.v2.RecapArticleRange"> & {
  /**
   * @generated from field: string from = 1;
   */
  from: string;
...
/**
 * Describes the message alt.recap.v2.RecapArticleRange.
 * Use `create(RecapArticleRangeSchema)` to create a new message.
 */
export const RecapArticleRangeSchema: GenMessage<RecapArticleRange> = /*@__PURE__*/
  messageDesc(file_alt_recap_v2_recap, 22);

/**
 * RecapArticleTag is a tag attached to an article
 *
 * @generated from message alt.recap.v2.RecapArticleTag
 */
export type RecapArticleTag = Message<"alt.recap.v2.RecapArticleTag"> & {
  /**
...
/**
 * Describes the message alt.recap.v2.RecapArticleTag.
 * Use `create(RecapArticleTagSchema)` to create a new message.
 */
export const RecapArticleTagSchema: GenMessage<RecapArticleTag> = /*@__PURE__*/
  messageDesc(file_alt_recap_v2_recap, 23);

/**
 * RecapArticleItem is a single article entry in the response
 *
 * @generated from message alt.recap.v2.RecapArticleItem
 */
export type RecapArticleItem = Message<"alt.recap.v2.RecapArticleItem"> & {
  /**
   * Article UUID
   *
   * @generated from field: string article_id = 1;
   ...
   *
   * @generated from field: repeated alt.recap.v2.RecapArticleTag tags = 7;
   */
  tags: RecapArticleTag[];
};

/**
 * Describes the message alt.recap.v2.RecapArticleItem.
 * Use `create(RecapArticleItemSchema)` to create a new message.
 */
export const RecapArticleItemSchema: GenMessage<RecapArticleItem> = /*@__PURE__*/
  messageDesc(file_alt_recap_v2_recap, 24);

/**
 * ListRecapArticlesResponse is the paginated response
 *
 * @generated from message alt.recap.v2.ListRecapArticlesResponse
 */
export type ListRecapArticlesResponse = Message<"alt.recap.v2.ListRecapArticlesResponse"> & {
  /**
   * Echo of requested window
   *
   * @generated from field: alt.recap.v2.RecapArticleRange range = 1;
   */
   ...
   *
   * @generated from field: repeated alt.recap.v2.RecapArticleItem articles = 6;
   */
  articles: RecapArticleItem[];
};

/**
 * Describes the message alt.recap.v2.ListRecapArticlesResponse.
 * Use `create(ListRecapArticlesResponseSchema)` to create a new message.
 */
export const ListRecapArticlesResponseSchema: GenMessage<ListRecapArticlesResponse> = /*@__PURE__*/
...
export const RecapService: GenService<{
   ...
   *
   * @generated from rpc alt.recap.v2.RecapService.ListRecapArticles
   */
  listRecapArticles: {
    methodKind: "unary";
    input: typeof ListRecapArticlesRequestSchema;
    output: typeof ListRecapArticlesResponseSchema;
  },
}> = /*@__PURE__*/
