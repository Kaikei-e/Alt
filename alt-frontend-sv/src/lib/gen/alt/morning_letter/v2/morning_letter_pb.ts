...
export type MorningLetterBulletEnrichment = Message<"alt.morning_letter.v2.MorningLetterBulletEnrichment"> & {
   ...
   * unavailable.
   *
   * @generated from field: string acolyte_href = 10;
   */
  acolyteHref: string;
};
