...
const SUPERSEDE_MAP: Record<string, SupersedeDisplay> = {
	summary_updated: {
		...
		iconName: "FileText",
		colorClass: "text-[var(--badge-sky-text)] border-[var(--badge-sky-border)] bg-[var(--badge-sky-bg)]",
	},
	tags_updated: {
		label: "Tags updated",
		iconName: "Tag",
		colorClass: "text-[var(--badge-indigo-text)] border-[var(--badge-indigo-border)] bg-[var(--badge-indigo-bg)]",
	},
	reason_updated: {
