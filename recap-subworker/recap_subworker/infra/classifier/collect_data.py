...
TAG_TO_GENRE = {
    ...
    "code": "software_dev",
    "script": "software_dev",
    "programming": "software_dev",
    "github": "software_dev",
    "docker": "software_dev",
    "開発": "software_dev",
    "技術": "software_dev",
    "実装": "software_dev",
    "プログラミング": "software_dev",
    "aws": "software_dev",
    "cloud": "software_dev",
    "linux": "software_dev",
    "ubuntu": "software_dev",
    ...
    "pixel": "consumer_tech",
    "galaxy": "consumer_tech",
    "ipad": "consumer_tech",
    "tablet": "consumer_tech",
    "macbook": "consumer_tech",
    "windows": "consumer_tech",
    "pc": "consumer_tech",
    "laptop": "consumer_tech",
    "device": "consumer_tech",
    "hardware": "consumer_tech",
    "gadget": "consumer_tech",
    "apple": "consumer_tech",
    "samsung": "consumer_tech",
    "google": "consumer_tech",  # Broad but often consumer
    # 5. Internet Platforms (internet_platforms)
    "social media": "internet_platforms",
    "facebook": "internet_platforms",
    "twitter": "internet_platforms",
    "x": "internet_platforms",
    "instagram": "internet_platforms",
    "tiktok": "internet_platforms",
    "youtube": "internet_platforms",
    "app store": "internet_platforms",
    "browser": "internet_platforms",
    # 6. Space & Astronomy (space_astronomy)
    "space": "space_astronomy",
    "nasa": "space_astronomy",
    "spacex": "space_astronomy",
    "astronomy": "space_astronomy",
    "moon": "space_astronomy",
    "mars": "space_astronomy",
    ...
    "carbon": "climate_environment",
    "emission": "climate_environment",
    "plastic": "climate_environment",
    # 8. Energy Transition (energy_transition)
    "energy": "energy_transition",
    "solar": "energy_transition",
    "wind": "energy_transition",
    "battery": "energy_transition",
    ...
    "doctor": "health_medicine",
    "hospital": "health_medicine",
    "health": "health_medicine",  # Broad, but fits here
    "covid": "health_medicine",
    "virus": "health_medicine",
    "vaccine": "health_medicine",
    "mental health": "health_medicine",
    # 10. Life Science (life_science)
    "biology": "life_science",
    "genetics": "life_science",
    "dna": "life_science",
    "biotech": "life_science",
    "research": "life_science",
    "science": "life_science",  # 'science' is broad, maybe skip?
    # 11. Macroeconomics (economics_macro)
    "economy": "economics_macro",
    "inflation": "economics_macro",
    "gdp": "economics_macro",
    "interest rate": "economics_macro",
    "employment": "economics_macro",
    "recession": "economics_macro",
    # 12. Markets & Finance (markets_finance)
    "stock": "markets_finance",
    "market": "markets_finance",
    "investing": "markets_finance",
    "finance": "markets_finance",
    "crypto": "markets_finance",
    "bitcoin": "markets_finance",
    "bank": "markets_finance",
    "earnings": "markets_finance",
    "nasdaq": "markets_finance",
    # 13. Startups & Innovation (startups_innovation)
    "startup": "startups_innovation",
    "venture capital": "startups_innovation",
    "funding": "startups_innovation",
    "innovation": "startups_innovation",
    "entrepreneur": "startups_innovation",
    "founder": "startups_innovation",
    # 14. Industry & Logistics (industry_logistics)
    "industry": "industry_logistics",
    "supply chain": "industry_logistics",
    "logistics": "industry_logistics",
    "manufacturing": "industry_logistics",
    "factory": "industry_logistics",
    "production": "industry_logistics",
    ...
    "vote": "politics_government",
    "parliament": "politics_government",
    "congress": "politics_government",
    "democrat": "politics_government",
    "republican": "politics_government",
    "senate": "politics_government",
    "prime minister": "politics_government",
    "president": "politics_government",
    "biden": "politics_government",
    "trump": "politics_government",
    "campaign": "politics_government",
    "policy": "politics_government",
    # 16. Diplomacy & Security (diplomacy_security)
    "diplomacy": "diplomacy_security",
    "war": "diplomacy_security",
    "military": "diplomacy_security",
    "defense": "diplomacy_security",
    "nato": "diplomacy_security",
    "geopolitics": "diplomacy_security",
    ...
    "work": "labor_workplace",
    "job": "labor_workplace",
    "career": "labor_workplace",
    "hiring": "labor_workplace",
    "workplace": "labor_workplace",
    "remote work": "labor_workplace",
    "salary": "labor_workplace",
    # 20. Society & Demographics (society_demographics)
    "society": "society_demographics",
    "population": "society_demographics",
    "migration": "society_demographics",
    "gender": "society_demographics",
    "welfare": "society_demographics",
    # 21. Culture & Arts (culture_arts)
    "art": "culture_arts",
    "culture": "culture_arts",
    "museum": "culture_arts",
    "exhibition": "culture_arts",
    ...
    "tourism": "travel_places",
    "hotel": "travel_places",
    "airline": "travel_places",
    "flight": "travel_places",
    "vacation": "travel_places",
    "resort": "travel_places",
    # 27. Home & Living (home_living)
    "home": "home_living",
    "house": "home_living",
    "interior": "home_living",
    "furniture": "home_living",
    "garden": "home_living",
    "diy": "home_living",
    "lifehack": "home_living",
    # 28. Games & Esports (games_esports)
    "game": "games_esports",
    "games": "games_esports",
    "gaming": "games_esports",
    "esports": "games_esports",
    "nintendo": "games_esports",
    "sony": "games_esports",
    "playstation": "games_esports",
    "xbox": "games_esports",
    "steam": "games_esports",
    "ps5": "games_esports",
    "anime": "games_esports",
    "manga": "games_esports",
    "comics": "games_esports",
    "アニメ": "games_esports",
    "漫画": "games_esports",  # Often crossover, but close enough
    # 29. Mobility & Automotive (mobility_automotive)
    "car": "mobility_automotive",
    "auto": "mobility_automotive",
    "ev": "mobility_automotive",
    "tesla": "mobility_automotive",
    "toyota": "mobility_automotive",
    "transport": "mobility_automotive",
    "train": "mobility_automotive",
    "bus": "mobility_automotive",
    "mobility": "mobility_automotive",
    # 30. Consumer & Products (consumer_products)
    "shopping": "consumer_products",
    "retail": "consumer_products",
    "product": "consumer_products",
    "brand": "consumer_products",
    "sale": "consumer_products",
    "amazon": "consumer_products",
    "price": "consumer_products",
    "discount": "consumer_products",  # Context dependent, but often consumer
}
