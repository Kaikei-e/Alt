...
from recap_subworker.app.infra.pki.config import PkiError
...
class LoadedCert:
    ...
    def __init__(self, not_before: datetime, not_after: datetime, common_name: str) -> None:
    ...
    def _cleanup_temps(self) -> None:
        for directory in {self.cert_path.parent, self.key_path.parent}:
            ...
            for child in directory.iterdir():
                if child.name.startswith((_ENROLL_PREFIX, _STAGE_PREFIX, _RESTORE_PREFIX)):
